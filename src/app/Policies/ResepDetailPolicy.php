...
class ResepDetailPolicy
{
    ...
    {
        return $user->can('view_any_resep::detail');
    }
    ...
    {
        return $user->can('view_resep::detail');
    }
    ...
    {
        return $user->can('create_resep::detail');
    }
    ...
    {
        return $user->can('update_resep::detail');
    }
    ...
    {
        return $user->can('delete_resep::detail');
    }
    ...
    {
        return $user->can('delete_any_resep::detail');
    }
     ...
     */
    public function replicate(User $user, ResepDetail $resepDetail): bool
    {
